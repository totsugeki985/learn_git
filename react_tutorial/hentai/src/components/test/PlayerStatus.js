...
class PlayerStatus extends Component
{
        ...
        this.SingleValue = (props)=>
        {
            return(
                <components.SingleValue {...props}>
                    <img src={this.state.selectedOption.icon}/> {this.state.selectedOption.label}
    ...
    render()
    {
        ...
        const styles = 
        {
            ...
            {
                return{
                    backgroundImage : "url(/pm/default_style/scroll_arrow_down.jpg)",
        ...
        <div>
            ...
            <Select 
                placeholder={<div><img src={this.initialStatus.icon}/> {this.initialStatus.label}</div>}
